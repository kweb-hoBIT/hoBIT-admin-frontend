...
import { CheckSeniorFAQCategoryDuplicateResponse } from "../../types/seniorfaq";

type SeniorFAQCategoryChangeProps = {
  changedData: CheckSeniorFAQCategoryDuplicateResponse['data']['changedData'];
  onHandleCategoryChangeClose: () => void;
};

const SeniorFAQCategoryChange: React.FC<SeniorFAQCategoryChangeProps> = ({ changedData, onHandleCategoryChangeClose }) => {
  return (
...
export default SeniorFAQCategoryChange;
